...
- `server/` — Node.js WebSocket server for online multiplayer (ws + chess.js)
- `render.yaml` — Render.com deployment config for the server
...
4. Add support for two player playing from 2 different browsers. The game state should be save in a database. 